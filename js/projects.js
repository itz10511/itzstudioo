...
const vimeo = (id) => ({ type: 'vimeo', id: String(id) });
...
window.PROJECTS = [
  ...
  // 1 ─────────────────────────────────────
  {
    ...
    category: ['photo'],
    year: 2024,
    cover: CDN('v1773630202/DSC06708_t9ju3c.jpg'),
    items: [
  ...
  // 3 ─────────────────────────────────────
  {
    ...
    year: 2025,
    cover: CDN('v1773633505/mochakk3_p46cmx.jpg'),
    items: [
      // Digital photos
      ...
      img('v1773633630/IMG_6219_w8treq.jpg'),
  ...
  // 4 ─────────────────────────────────────
  {
    ...
    category: ['film', 'video'],
    year: 2026,
    cover: CDN('v1773636173/IMG_9233_pygfni.jpg'),
    items: [
      // Southstarr video clips
      vimeo(1173874341),
      vimeo(1173874616),
  ...
  // 5 ─────────────────────────────────────
  {
    ...
    items: [
      ...
      img('v1773634482/IMG_1786_gjczig.jpg'),
  ...
  // 6 ─────────────────────────────────────
  {
    ...
    category: ['photo', 'film'],
    year: 2024,
    cover: CDN('v1773630210/DSC03597_s3rcqy.jpg'),
    items: [
      // Digital photos
  ...
  // 7 ─────────────────────────────────────
  {
    ...
    category: ['photo', 'film', 'video'],
    year: 2024,
    cover: CDN('v1773634540/IMG_1876_2_ki1xke.jpg'),
    items: [
      // Beltran video clips
      vimeo(1173873417),
      vimeo(1173873368),
      vimeo(1173873408),
      vimeo(1173873355),
      // Cole Terrazas video clips
      vimeo(1173873719),
      vimeo(1173873689),
      vimeo(1173873601),
      // Beltran digital photos
  ...
  // 8 ─────────────────────────────────────
  {
    ...
    category: ['photo', 'video'],
    year: 2024,
    cover: CDN('v1773633472/DSC07061_t1fkpg.jpg'),
    items: [
      vimeo(1173885497),
      vimeo(1173885477),
  ...
  // 9 ─────────────────────────────────────
  {
    ...
    category: ['photo'],
    year: 2024,
    cover: CDN('v1773633465/DSC08900_bx5bez.jpg'),
    items: [
